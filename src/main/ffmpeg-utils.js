  ...
  return new Promise((resolve, reject) => {
    ...
    proc.on('close', (code) => {
      ...
      try {
        ...
        const nbFrames = parseInt(videoStream.nb_read_frames || videoStream.nb_frames || '0', 10);
 ...
 */
function remuxToCleanMp4(inputPath, outputPath, onProgress = null, targetFps = 30) {
  ...
  const args = [
    ...
    '-r', String(fps),
    '-c:v', 'libx264',
    '-preset', 'ultrafast',  // speed — this is just an intermediate file
